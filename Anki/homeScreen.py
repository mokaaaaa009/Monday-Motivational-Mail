...
secondWindow.title("N5 Japanese Kanji second")
secondWindow.config(bg="blue")
myCanvas=Canvas(width=1000,height=526,highlightthickness=0,bg=BACKGROUND_COLOR)
myCanvas.grid(row=0,column=0,columnspan=2)

reviewImage=PhotoImage(file="revision.png")
startImage=PhotoImage(file="start.png")


review_Btn=Button(image=reviewImage,width=300,height=300,pady=10)
review_Btn.grid(row=0,column=0)

start_Btn=Button(image=startImage,width=300,height=300,pady=10)
